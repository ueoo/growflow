...
def compute_chamfer_between_point_and_mesh(
    means_trajectory, mesh_path, timestep, n=100_000, use_mesh_vertices=False, closest_indices=None
):
    """
    ...
    )  # NOTE: this implicitly is "merging" point clouds, so u won't be able to track anything here

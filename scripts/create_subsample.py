...
def subsample_dataset(
    original_data_dir: str, output_data_dir: str, every_n: int = 2, always_include_last: bool = True
):
    """
    ...
    new_train_transforms = {"camera_angle_x": train_transforms["camera_angle_x"], "frames": new_frames}

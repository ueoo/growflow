...
def main():
    parser = argparse.ArgumentParser(description="Process mask inversion in parallel across multiple dates")

    parser.add_argument("--dates", nargs="+", help="List of dates to process (e.g., --dates 2024-01-01 2024-01-02)")

    parser.add_argument(
        "--base-path", default="../data/dynamic/captured/pi_plant5_selected", help="Base path containing date folders"
    )

    parser.add_argument(
        "--auto-discover", action="store_true", help="Automatically discover all date folders in base path"
    )

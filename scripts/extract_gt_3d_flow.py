...
if __name__ == "__main__":
    ...
    is_reverse = True
    folders = [
        "../data/dynamic/blender/360/multi-view/31_views/lily_transparent_final_small_vase_70_timesteps/meshes/relevant_lily_meshes",
    ...
    folders = [
        "../data/dynamic/blender/360/multi-view/31_views/plant_1_transparent_final_small_vase_70_timesteps/meshes/relevant_plant_1_meshes",
    ...
    folders = [
        "../data/dynamic/blender/360/multi-view/31_views/rose_transparent_final_small_vase_70_timesteps_reversed/meshes/relevant_rose_meshes"
    ]
    ...
    folders = [
        "/scratch/ondemand28/weihanluo/neural_ode_splatting/data/dynamic/blender/360/multi-view/31_views/lily_transparent_final_small_vase_70_timesteps_subsample_2/meshes/relevant_lily_meshes"
    ]
    #    "../data/dynamic/blender/360/multi-view/31_views/tulip_transparent_final_small_vase_70_timesteps/meshes/relevant_tulip_meshes"]
    ...
    for mesh_folder in folders:
        ...
        use_vertices = (
            args.use_vertices
        )  # using vertices is better cause no need to guess number of gaussians to sample.
        if use_vertices:
        ...
        gt_mesh_t0 = trimesh.load_mesh(
            first_mesh_path, process=False
        )  # NOTE: setting process =false prevent vertex merging

...
def visualize_point_cloud(
    ...
    if show_convex_hull and len(point_clouds) >= 4:  # Need at least 4 points for 3D hull
        try:
            ...
            hull = ConvexHull(point_clouds)  # type: ignore
            ...
            hull_collection = Poly3DCollection(  # type: ignore
                hull_faces,
                alpha=hull_alpha,
...
if __name__ == "__main__":
    ...
    output_dirs_dict = {
        "rose": "/scratch/ondemand28/weihanluo/neural_ode_splatting/results/rose_transparent_final_small_vase_70_timesteps/final/gt",

...
def collect_mask_paths(mask_folder_path):
    ...
    mask_files = [f for f in mask_folder_path.iterdir() if f.is_file() and f.suffix.lower() in image_extensions]
...
if __name__ == "__main__":
    ...
    base_directory = os.path.join(
        "/scratch/ondemand28/weihanluo/neural_ode_splatting/data/dynamic/captured/pi_plant5_shorter", args.date
    )
